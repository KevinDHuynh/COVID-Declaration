...
<body>
    <div class="main">
        ...
        <div class="container">
            ...
            <div class="tab">
                <button class="tablinks" onclick="showTableContent(event, 'graphs')" id="defaultOpen">Overview</button>
                <button class="tablinks" onclick="showTableContent(event, 'passenger')">Passenger</button>
            </div>
            <!-- Overview: Graphs -->
